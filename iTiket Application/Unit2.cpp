...
ComboBox1->Text=ADOQuery1->FieldByName("pesawat")->AsString;
ComboBox2->Text=ADOQuery1->FieldByName("keberangkatan")->AsString;
DateTimePicker1->DateTime=ADOQuery1->FieldByName("waktu_keberangkatan")->AsString;
ComboBox3->Text=ADOQuery1->FieldByName("kedatangan")->AsString;
DateTimePicker2->Date=ADOQuery1->FieldByName("waktu_kedatangan")->AsString;
Edit1->Text=ADOQuery1->FieldByName("no_pesawat")->AsString;
SpinEdit1->Text=ADOQuery1->FieldByName("jumlah_pemberhentian")->AsString;
Edit2->Text=ADOQuery1->FieldByName("keterangan")->AsString;
